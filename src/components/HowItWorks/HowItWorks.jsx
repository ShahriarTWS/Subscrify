            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 mt-6 text-center'>
                ...
                <div className='card bg-base-200 flex flex-col justify-center items-center gap-4 py-4'>
                    ...
                    <div className='space-y-4'>
                        ...
                        <p className='md:w-3/4 mx-auto text-gray-500'>Every subscription box includes handpicked premium tools, devices, and projects to supercharge your tech journey. Average value over $150 per box.</p>
                    </div>
                </div>
